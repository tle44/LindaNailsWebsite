                    ...
                    <div className="flex flex-wrap ">
                        <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/3 mb-4 px-2 ">
                            <div className="w-40 mx-auto flex flex-col items-center gap-4 ">
                                <GrLocation className=" text-center text-4xl h-20 w-20 shadow-sm p-5 rounded-full bg-violet-100 dark:bg-violet-400" />
                        ...
                        <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/3 mb-4 px-2">
                            <div className="w-40 mx-auto flex flex-col items-center gap-4">
                                ...
                                <div className="text-center">
                                    Monday - Saturday 10:00 AM - 7:00 PM Sunday:
                                    Closed
                                </div>
                            </div>
                        </div>
